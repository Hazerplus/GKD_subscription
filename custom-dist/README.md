...
|起点读书|15|<li>开屏广告<li>更新提示<li>青少年模式<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>局部广告-悬浮广告<li>评价提示<li>功能类-自动[展开]书籍简介<li>功能类-扫描自动确认[登录]<li>局部广告-信息流广告<li>功能类-福利中心看完广告-知道了<li>全屏广告-红包弹窗<li>功能类-移动网络下自动点击播放视频<li>功能类-自动签到<li>功能类-订阅至最新章后自动[返回]|
...
|小飞机网盘|1|<li>分段广告|
|小黑盒|3|<li>功能类-签到成功弹窗<li>局部广告-卡片广告<li>功能类-自动[查看原图]|
|小红帽|1|<li>全屏广告-弹窗广告|
