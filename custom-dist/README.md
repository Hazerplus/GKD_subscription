...
|AB DM|1|<li>功能类-自动展开各下载线程|
|AfuseKt|1|<li>更新提示|
|AlgerMusicPlayer|1|<li>开屏广告|
...
|AppShare|9|<li>开屏广告<li>局部广告-卡片广告<li>功能类-自动签到<li>分段广告<li>全屏广告-弹窗广告<li>通知提示-公告弹窗<li>功能类-自动点击[使用浏览器打开]<li>更新提示<li>功能类-自动进入应用更新界面|
|Authenticator|1|<li>评价提示|
...
|Canta|1|<li>其他-卸载应用后弹窗|
|Cellular-Z|1|<li>更新提示|
|CFMOTO|1|<li>全屏广告-弹窗广告|
|ChatGPT|7|<li>通知提示-充值Plus提示<li>功能类-ban话题提前阻断屏蔽<li>局部广告<li>通知提示-聊天记忆容量警告<li>功能类-自动打开联网查询<li>功能类-上传/发送错误自动重试<li>功能类-自动保存图片|
|Chrome|1|<li>功能类-文件可能有害-点击[仍然下载]|
|Cimoc|1|<li>全屏广告-弹窗广告|
|Clash Meta for Android|2|<li>功能类-代理页面自动点击延迟测试<li>功能类-自动[启动]后返回|
|Clock|1|<li>功能类-自动关闭闹钟提示|
...
|DeepSeek|3|<li>功能类-自动折叠思考过程<li>功能类-思考完成后自动折叠思考过程<li>功能类-选中快速模式时自动切换至专家模式|
|Duolingo|1|<li>全屏广告-试用会员|
|EASI|1|<li>全屏广告|
|ECOVACS HOME|1|<li>开屏广告|
|Edge|7|<li>权限提示-通知权限<li>功能类-[关闭所有标签？]弹窗<li>功能类-关闭标签页<li>功能类-[前往CSDN APP阅读全文]弹窗<li>功能类-自动打开外部应用<li>功能类-分享预览页选择在 Edge 中打开<li>功能类-自动确认下载|
|Extinguish|1|<li>功能类-自动点击[启动]|
|Eyeplus|2|<li>全屏广告-弹窗广告<li>局部广告-卡片广告|
|Facebook|1|<li>功能类-自动点击[查看翻译]|
|Fantuan Delivery|4|<li>权限提示-通知权限<li>评价提示<li>局部广告-悬浮广告<li>全屏广告|
|fiil+|1|<li>功能类-自动连接耳机|
|Fing|1|<li>其他-教程弹窗|
|FlClash|1|<li>功能类-节点自动测延迟|
|FlowMark|1|<li>更新提示|
|Gemini|1|<li>其他-⚠️请移步至Google应用规则页(壳App)|
|GitHub|2|<li>功能类-自动批准授权验证<li>功能类-PR自动展开详情|
|GKD|1|<li>功能类-删除快照二次提示|
|Gmail|2|<li>分段广告-信息流广告<li>局部广告-首页卡片|
|Go-Goal|1|<li>开屏广告|
|Google|4|<li>全屏广告-Gemini-个性化Tip<li>局部广告-Gemini-试用新功能<li>功能类-Gemini-对话连接中断重试<li>局部广告-Gemini-个性化Tip|
|Grok|2|<li>评价提示<li>功能类-发生错误自动重试|
...
|InstallerX|1|<li>其他-⚠️请移步软件包安装程序|
|InstallerX Revived|1|<li>其他-⚠️请移步软件包安装程序|
...
|Kimi|2|<li>评价提示<li>权限提示-通知权限|
|KMB . LWB|1|<li>开屏广告|
|Lanerc|2|<li>通知提示-公告弹窗<li>全屏广告-弹窗广告|
|LIBVIO|1|<li>其他-账号注册说明弹窗|
|LINE|1|<li>分段广告-主页信息流广告|
|LocalSend|1|<li>功能类-文件传输时自动点击[高级]|
...
|Mubeat|1|<li>全屏广告|
|MyComic|1|<li>开屏广告|
|MyTherapy|4|<li>全屏广告<li>功能类-快速添加按需药物<li>功能类-自动点击剂量调整<li>功能类-库存低3s自动编辑|
|Nekogram|1|<li>更新提示|
...
|Outlook|1|<li>分段广告-收件箱顶部广告|
|Photoshop Express|1|<li>评价提示|
|PicACG|5|<li>开屏广告<li>通知提示-公告弹窗<li>局部广告-漫画详情页广告<li>功能类-自动签到<li>功能类-流量提醒弹窗|
|PICO|1|<li>更新提示|
|PiliPlus|1|<li>功能类-分P视频跳转|
|Play Integrity API Checker|1|<li>功能类-自动[检测]设备完整性|
|PokeHub|2|<li>更新提示<li>全屏广告-订阅广告|
|QCY|1|<li>局部广告-我的-卡片广告|
|QQ|20|<li>开屏广告<li>局部广告<li>分段广告<li>功能类-登录授权<li>功能类-自动勾选原图<li>功能类-自动点击查看原图<li>开屏广告-QQ小程序开屏广告<li>更新提示<li>更新提示-消息页面-顶部<li>局部广告-聊天页面广告<li>功能类-自动领取群聊红包<li>功能类-申请入群后自动点击右上角关闭<li>功能类-授权登录时关闭获取QQ好友关系<li>其他-联系人页面-顶部可能认识的人推荐<li>功能类-自动解锁 Windows QQ<li>功能类-关闭体验模式提醒<li>功能类-自动跳转第三方应用<li>功能类-不看或隐藏[官方Qzone]的动态<li>分段广告-QQ空间空友爱看<li>局部广告-空间相册内广告|
|Quetta|2|<li>功能类-自动跳转第三方应用<li>功能类-自动[保留]下载文件|
|QuickEdit|1|<li>功能类-自动点击完成|
|Quora|1|<li>分段广告-信息流广告|
|RAR|1|<li>全屏广告-订购 RAR 弹窗|
|RayLink|3|<li>更新提示<li>功能类-自动确认[退出]<li>通知提示-首页反诈骗提示|
|ReadEra|4|<li>评价提示-分享提示<li>全屏广告<li>全屏广告-高级版<li>评价提示|
|Reddit|4|<li>其他-关闭订阅社区消息提示<li>其他-NSFW 内容提示<li>功能类-自动点击翻译<li>分段广告-卡片广告|
...
|Steam|1|<li>功能类-自动展开信息|
|SteamPY|3|<li>开屏广告<li>更新提示<li>功能类-首页优惠券弹窗自动点击领取/使用|
|TapTap|3|<li>分段广告-游戏浏览页面推荐广告<li>更新提示<li>青少年模式-首页顶部横幅提示|
|Telegram|5|<li>权限提示-通知权限<li>局部广告-顶部横幅提示<li>权限提示-通讯录权限<li>功能类-更多-保存到相册<li>功能类-只保存单个媒体|
|Telegram|5|<li>更新提示<li>其他-添加生日提示<li>权限提示-通讯录权限<li>功能类-更多-保存到相册<li>功能类-只保存单个媒体|
|Telegram+ (Plus Messenger)|4|<li>功能类-更多-保存到相册<li>功能类-更多-只保存单个媒体<li>权限提示-通讯录权限<li>权限提示-安装未知应用|
...
|TIM|3|<li>功能类-自动点击查看原图<li>功能类-发送图片时自动勾选[原图]<li>功能类-权限申请自动授权|
|ToDesk|2|<li>局部广告-卡片广告<li>通知提示-套餐到期|
|TradingView|2|<li>局部广告-卡片广告<li>全屏广告|
|Tumblr|1|<li>分段广告-信息流广告|
|TwiTake|1|<li>评价提示-评分弹窗|
|v2rayNG|2|<li>功能类-开屏连代理<li>功能类-自动测试连接|
|Via|1|<li>功能类-自动[确认]下载|
...
|WPS Office|11|<li>分段广告-首页文档列表广告<li>全屏广告<li>更新提示<li>功能类-关闭[开启WPS云服务]弹窗<li>分段广告-文档末尾广告<li>局部广告<li>功能类-自动签到<li>评价提示<li>其他-x掉添加至主屏幕<li>功能类-关闭[登录WPS]弹窗<li>局部广告-会员功能试用提示|
|WPS Office Lite|2|<li>全屏广告<li>权限提示-通知权限|
|Xfinity|1|<li>全屏广告|
|YouTube|1|<li>功能类-关闭底部播放横条|
|YouTube|16|<li>全屏广告-视频播放-跳过广告<li>全屏广告-视频播放-赞助商广告<li>全屏广告-会员广告<li>权限提示-通知权限<li>功能类-自动翻译评论<li>其他-关闭播放器无障碍辅助弹窗<li>功能类-关闭视频播放结束后的推荐视频<li>局部广告<li>分段广告-播放页广告<li>功能类-自动展开更多回复<li>功能类-跳过视频内容警告<li>功能类-退出自动关闭小窗<li>全屏广告-Shorts-赞助商广告<li>评价提示-评论满意度评价<li>局部广告-视频播放-跳过调查<li>其他-xp模块更新提示|
|YouTube Music|1|<li>全屏广告-会员广告|
|YouTube Music|3|<li>局部广告-播放界面广告<li>全屏广告-会员广告<li>通知提示-隐私提醒|
|YouTube ReVanced|3|<li>全屏广告-会员广告<li>功能类-自动翻译评论<li>功能类-退出自动关闭小窗|
|YouTube RVX|1|<li>功能类-评论区自动点击[翻译成中文]|
|ZAKER|1|<li>开屏广告|
|Zepp Life|1|<li>局部广告-首页-底部广告|
|ZzzFun|1|<li>全屏广告-弹窗广告|
|(三星)软件包安装程序|2|<li>局部广告<li>功能类-跳过安全使用协议|
|(小米)电子邮件|3|<li>权限提示-自启动<li>功能类-自动切换到[合并账户]<li>评价提示|
|(vivo)主题|3|<li>开屏广告<li>全屏广告-推广弹窗<li>功能类-[添加主题卡片至桌面]弹窗|
|10000社区|1|<li>开屏广告|
|115生活|2|<li>功能类-自动签到<li>更新提示|
|123云盘|6|<li>全屏广告<li>更新提示<li>功能类-扫码自动确认登录<li>全屏广告-相册自动备份弹窗<li>分段广告<li>局部广告|
...
|爱山东|1|<li>开屏广告|
|爱听书|1|<li>全屏广告|
|爱玩机工具箱|2|<li>功能类-忽略授权提示<li>功能类-每日自动签到|
|爱吾游戏宝盒|1|<li>青少年模式|
|安吉星|1|<li>开屏广告|
...
|安小家|3|<li>全屏广告-弹窗广告<li>更新提示<li>局部广告|
...
|百变大侦探|2|<li>全屏广告-弹窗广告<li>全屏广告-签到弹窗|
...
|百度贴吧|13|<li>开屏广告<li>权限提示-通知权限<li>分段广告-信息流广告<li>局部广告-首页、推荐列表顶部卡片广告<li>局部广告-游戏类推广<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-悬浮小广告<li>局部广告-[帖子内/吧内]底部悬浮窗<li>功能类-贴吧内签到并关闭弹窗<li>局部广告-帖子底部话题卡片<li>全屏广告-会员弹窗<li>局部广告-感兴趣的吧推广|
...
|倍思|1|<li>权限提示-定位请求|
|崩坏：星穹铁道|1|<li>开屏广告-用户协议|
|比亚迪王朝|1|<li>更新提示|
|比翼多开|1|<li>全屏广告-弹窗广告|
|币安|1|<li>更新提示|
|必剪|2|<li>权限提示-通知权限<li>更新提示|
|哔哩哔哩|33|<li>开屏广告<li>局部广告-评论区顶部公告横幅<li>分段广告-动态推荐卡片广告<li>功能类-自动[展开]视频简介<li>更新提示<li>局部广告-视频页广告<li>局部广告-直播间悬浮窗广告<li>权限提示-通知权限<li>分段广告-首页推荐视频卡片广告<li>局部广告-个性化内容推荐弹窗<li>全屏广告-会员弹窗<li>全屏广告-分享稿件弹窗<li>分段广告-搜索结果广告<li>分段广告-视频详情页下方推广<li>功能类-自动关闭故事模式<li>功能类-自动点击评论区的[展开更多评论]<li>功能类-自动领取会员经验<li>功能类-自动点击查看原图<li>评价提示<li>功能类-直播自动点赞<li>功能类-直播自动投喂粉丝团<li>功能类-视频自动x1.25倍速(⚠️三选一)<li>功能类-视频自动x1.5倍速(⚠️三选一)<li>功能类-视频自动x2.0倍速(⚠️三选一)<li>功能类-折叠评论自动展开<li>局部广告-首页浮标广告<li>权限提示-悬浮窗权限<li>局部广告-顶部黄色横幅提示<li>功能类-创作中心自动展开更多<li>局部广告-会员购<li>局部广告-视频页-即将展示Ad<li>其他-完善信息弹窗<li>局部广告-视频详情页UP主推荐广告|
...
|菜鸟|9|<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>更新提示<li>权限提示-通知权限<li>评价提示<li>功能类-询问[是否要查询包裹]弹窗<li>功能类-包裹页面-自动展开更多物流信息<li>其他-好友代取功能提示<li>局部广告-超时享服务|
|畅听FM|1|<li>全屏广告-弹窗广告|
|超级课程表|4|<li>局部广告-首页卡片广告<li>局部广告-课程表界面广告<li>全屏广告-弹窗广告<li>更新提示|
|车来了|6|<li>局部广告-卡片广告<li>更新提示<li>全屏广告-弹窗广告<li>功能类-自动选第1个车🚗<li>功能类-自动选第1个车🚗后打开地图🗺️<li>功能类-网络错误自动重试|
|车旺大卡|1|<li>全屏广告-弹窗广告|
|车学堂|1|<li>局部广告-卡片广告|
|车e兴|1|<li>开屏广告|
|虫虫助手|1|<li>全屏广告|
...
|動畫瘋|1|<li>其他-动画疯年龄限制|
|抖省省|1|<li>功能类-自动[放弃支付]|
|抖音|2|<li>功能类-发现通讯录好友弹窗<li>权限提示-定位权限|
|抖音|30|<li>开屏广告<li>局部广告<li>更新提示-关闭更新弹窗<li>功能类-自动[查看原图]<li>权限提示-通知权限<li>功能类-自动勾选原图<li>其他-休息提醒<li>全屏广告-小组件弹窗<li>全屏广告<li>权限提示-通讯录权限<li>青少年模式<li>权限提示-定位权限<li>全屏广告-汽水音乐VIP<li>其他-个性化推荐弹窗<li>功能类-刷到推广视频时[上滑]<li>功能类-刷到游戏视频时[上滑]<li>功能类-刷到直播时[上滑]<li>功能类-自动领取别人发的红包<li>功能类-自动抢口令红包<li>权限提示-相机权限<li>功能类-评论区-自动展开评论<li>功能类-评论区-自动展开评论_全部<li>局部广告-直播间右下角浮窗<li>局部广告-直播-关闭推荐直播间<li>局部广告-评论区-评论氛围满意度<li>功能类-评论区-展开部分折叠评论<li>全屏广告-视频流-是广告认可不?[上滑]<li>局部广告-视频流-当前直播满意?<li>其他-账号详情-商品页<li>局部广告-视频流-左下角卡片|
|抖音极速版|12|<li>更新提示<li>功能类-功能体验邀请弹窗<li>局部广告-打招呼表情<li>全屏广告-朋友推荐弹窗<li>权限提示-通知权限<li>功能类-选择图片时自动勾选原图<li>全屏广告<li>全屏广告-添加桌面小组件<li>功能类-刷到推广视频时[上滑]<li>局部广告-商品卡片<li>分段广告-搜索结果页广告<li>功能类-自动切换到[作品]列表|
|抖音精选|2|<li>更新提示<li>评价提示|
|斗鱼|1|<li>局部广告-直播间广告|
|豆瓣|8|<li>开屏广告<li>分段广告<li>评价提示-关闭评分反馈弹窗<li>功能类-长按图片后[保存]<li>局部广告-卡片广告<li>全屏广告-弹窗广告<li>更新提示<li>其他-标记看过的影视弹窗|
|豆包|1|<li>功能类-自动创建新对话|
|毒霸姬|1|<li>更新提示|
...
|儿歌多多|1|<li>局部广告-卡片广告|
|二柄|1|<li>分段广告|
|发现精彩|2|<li>开屏广告<li>全屏广告|
|番茄免费小说|13|<li>开屏广告<li>更新提示<li>局部广告-首页右侧悬浮广告<li>全屏广告<li>全屏广告-阅读页面关注作者弹窗<li>分段广告-阅读页面广告<li>评价提示-请求好评弹窗<li>权限提示-通知权限<li>功能类-误入直播后自动[退出]<li>功能类-看广告自动领奖励<li>评价提示-点评此书弹窗<li>功能类-观看广告自动静音<li>其他-添加桌面小组件|
|番茄音乐（原畅听音乐）|5|<li>全屏广告<li>分段广告<li>功能类-自动展开回复<li>功能类-关联抖音账号登录弹窗<li>局部广告|
|番喜视频|1|<li>全屏广告-弹窗广告|
|番喜视频|1|<li>全屏广告|
|番喜视频|1|<li>全屏广告|
|返利|1|<li>全屏广告-弹窗广告|
|飞客|2|<li>全屏广告-弹窗广告<li>局部广告-信息流广告|
|飞猫管家|1|<li>开屏广告|
...
|古诗文网|1|<li>分段广告-弹窗广告|
|古文岛|1|<li>全屏广告-弹窗广告|
|谷歌相册|3|<li>更新提示<li>全屏广告-会员广告<li>全屏广告-弹窗广告|
|观星|1|<li>全屏广告-弹窗广告|
...
|果冻宝盒|1|<li>全屏广告-弹窗广告|
|哈啰|8|<li>更新提示<li>权限提示-悬浮窗权限<li>权限提示-通知权限<li>权限提示-定位权限<li>全屏广告-弹窗广告<li>全屏广告-关闭公众号提醒<li>局部广告-右侧悬浮广告<li>其他-新人教学弹窗|
|哈啰顺风车|2|<li>全屏广告-弹窗广告<li>权限提示-通知权限|
...
|华为应用市场|8|<li>开屏广告<li>更新提示<li>功能类-应用更新页面-点击[查看更多]<li>全屏广告-热门应用推荐弹窗<li>局部广告-卡片广告<li>权限提示-通知权限<li>功能类-自动安装应用<li>功能类-关闭自动更新提示|
|华为阅读|1|<li>开屏广告|
...
|华夏直通|2|<li>功能类-每日自动签到<li>功能类-自动关闭首页提示|
...
|今日头条|11|<li>更新提示<li>局部广告-浮窗广告<li>权限提示-通知权限<li>全屏广告-竖屏视频广告<li>分段广告-信息流广告<li>局部广告-底部话题推荐弹窗<li>功能类-自动观看广告视频<li>局部广告-底部热榜弹窗<li>功能类-[关联抖音账号]弹窗<li>功能类-[下次打开APP默认进入xx频道]弹窗<li>全屏广告-弹窗广告|
|今日头条极速版|1|<li>功能类-全自动续听书时长|
|今日校园|1|<li>更新提示|
|金山文档|3|<li>局部广告-列表卡片广告<li>更新提示<li>权限提示-通知权限|
|金十数据|3|<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-会员页面顶部广告|
|京东|14|<li>开屏广告<li>局部广告-购物车页面砸金蛋<li>局部广告-悬浮广告<li>权限提示-通知权限<li>全屏广告-弹窗广告<li>局部广告-横幅广告<li>功能类-京东账号登录授权<li>局部广告-支付页面产品推荐<li>全屏广告-购物车页面支付成功弹窗广告<li>全屏广告-加入购物车后出现的弹窗<li>功能类-支付订单后点击[完成/回首页]<li>功能类-支付订单后跳过开通[刷脸支付]<li>功能类-展开全部订单信息<li>功能类-确认收货成功-返回|
...
|橘汁|3|<li>局部广告<li>全屏广告<li>全屏广告-插屏广告|
|橘汁|2|<li>全屏广告<li>分段广告|
|橘汁|3|<li>全屏广告<li>局部广告-卡片广告<li>通知提示-公告|
|句子控|3|<li>全屏广告<li>功能类-[取消]转发给AI<li>分段广告|
|剧多多|1|<li>全屏广告-弹窗广告|
|剧兔|1|<li>全屏广告-弹窗广告|
|开发助手|1|<li>局部广告-卡片广告|
|看护家|1|<li>全屏广告-弹窗广告|
...
|酷安|8|<li>开屏广告<li>分段广告-信息流广告<li>更新提示<li>权限提示-通知权限<li>局部广告-[大家还下载了]应用推荐<li>局部广告-信息流广告<li>功能类-自动保存原图<li>功能类-消息已读自动[确定]|
|酷狗概念版|8|<li>开屏广告<li>全屏广告<li>分段广告-我的页面-右侧悬浮反馈图标<li>更新提示<li>功能类-播放页听歌领VIP<li>评价提示<li>分段广告-评论区广告<li>局部广告|
...
|快科技|1|<li>开屏广告|
|快连 VPN|2|<li>通知提示-各种提示弹窗<li>局部广告-顶部横幅|
|快手|6|<li>全屏广告-红包弹窗<li>局部广告-首页左侧红包悬浮控件<li>功能类-推荐关注<li>评价提示<li>全屏广告-直播间广告<li>分段广告-信息流广告|
|快手极速版|9|<li>开屏广告<li>全屏广告-朋友推荐弹窗<li>全屏广告-红包弹窗<li>全屏广告-个人主页弹窗<li>分段广告-悬浮广告<li>评价提示<li>功能类-刷到推广视频时[上滑]<li>局部广告-用户资料页广告<li>功能类-刷到直播时[上滑]|
|快牙|1|<li>局部广告-卡片广告|
|垃圾清理|1|<li>全屏广告-添加桌面图标提示|
|岚图汽车|1|<li>功能类-自动签到|
|蓝岛|1|<li>通知提示-通知弹窗|
|懒懒视频|1|<li>全屏广告-弹窗广告|
...
|栗子漫画|2|<li>通知提示-公告弹窗<li>局部广告-阅读页底部横幅|
|联合早报|2|<li>开屏广告<li>局部广告-信息流广告|
|联通视频彩铃|1|<li>全屏广告-弹窗广告|
|联通云盘|1|<li>更新提示|
|联想浏览器HD|2|<li>更新提示<li>权限提示-通知权限|
|联想应用中心|2|<li>更新提示<li>权限提示-通知权限|
|两步路户外助手|3|<li>更新提示<li>全屏广告<li>权限提示-通知权限|
|邻里邦|1|<li>功能类-自动签到|
|临床决策|5|<li>更新提示<li>功能类-自动点击翻译<li>评价提示<li>功能类-上传后自动修改处方<li>功能类-自动跳转到浏览器访问|
|临床指南|3|<li>全屏广告<li>功能类-签到自动退出<li>功能类-说明书自动翻译|
|聆听音乐|1|<li>全屏广告-弹窗广告|
|流光助手|1|<li>开屏广告|
|流舟文件|1|<li>全屏广告-升级pro弹窗|
...
|慢慢买|3|<li>开屏广告<li>功能类-从剪贴板查历史价-拒绝<li>全屏广告-弹窗广告|
...
|美团|12|<li>开屏广告<li>更新提示<li>全屏广告-弹窗广告<li>评价提示-订单调查弹窗<li>局部广告-悬浮广告<li>权限提示-定位权限<li>权限提示-通知权限<li>全屏广告-新人返场特惠<li>全屏广告-视频页弹窗广告<li>功能类-付款后自动点击完成<li>局部广告-直播讲解悬浮窗<li>全屏广告-下单后开通月付提示|
...
|萌妹|1|<li>全屏广告-弹窗广告|
|萌娘百科|1|<li>局部广告-搜索页广告|
|咪咕快游|1|<li>更新提示|
|咪咕视频|5|<li>局部广告<li>更新提示<li>权限提示-通知权限<li>全屏广告-首页<li>评价提示|
|咪咕音乐|1|<li>更新提示|
|米家|3|<li>局部广告-卡片广告<li>更新提示-设备固件升级提示弹窗<li>局部广告-顶部横幅|
|米游社|6|<li>功能类-自动打卡<li>全屏广告-游戏版本活动<li>分段广告-游戏版本活动<li>功能类-米游自动签到全家桶<li>权限提示-通知权限<li>功能类-自动开启参量质变仪提醒|
...
|起点读书|16|<li>开屏广告<li>更新提示<li>青少年模式<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>局部广告-悬浮广告<li>评价提示<li>功能类-自动[展开]书籍简介<li>功能类-扫描自动确认[登录]<li>局部广告-信息流广告<li>功能类-福利中心看完广告-知道了<li>全屏广告-红包弹窗<li>功能类-移动网络下自动点击播放视频<li>功能类-自动签到<li>功能类-订阅至最新章后自动[返回]<li>功能类-书友圈自动[打卡]|
|汽车之家|2|<li>全屏广告-弹窗广告<li>局部广告|
|汽水音乐|11|<li>开屏广告<li>更新提示<li>全屏广告-VIP弹窗<li>功能类-全自动看广告领VIP<li>功能类-看广告自动[静音]<li>评价提示-评分弹窗<li>局部广告-悬浮窗广告<li>其他-关闭[更多直播]推荐<li>功能类-全自动看广告领VIP_单日<li>局部广告-抖音看过视频提示浮窗<li>功能类-误入直播后自动[退出]|
...
|青藤之恋|1|<li>评价提示-好评弹窗|
|氢离子|2|<li>功能类-引用内容自动翻译<li>功能类-文献自动翻译|
|轻松阅|1|<li>全屏广告-弹窗广告|
|蜻蜓点金|1|<li>权限提示-通知权限|
...
|权限控制器|2|<li>权限提示-定位权限<li>权限提示-vivo-指定媒体内容|
|热剧猫|1|<li>全屏广告-弹窗广告|
|人民日报|1|<li>全屏广告-弹窗广告|
|人民日报|1|<li>局部广告-卡片广告|
...
|软件包安装程序|5|<li>功能类-自动安装应用<li>功能类-授权本次安装<li>功能类-继续安装高风险应用<li>功能类-勾选[已了解应用风险检测结果]<li>功能类-InstallerX自动安装|
...
|山姆会员商店|3|<li>开屏广告<li>权限提示-定位权限<li>局部广告-底部横幅广告|
|山香网校|2|<li>开屏广告<li>全屏广告-弹窗广告|
|闪动校园|1|<li>全屏广告|
|赏帮赚|4|<li>功能类-取消报名直接确认<li>功能类-上传自动选择截图<li>功能类-自动领取奖励<li>功能类-自动关闭[按要求提交信息]提示|
|上海公交|2|<li>局部广告-卡片广告<li>功能类-退出软件时的确认弹窗|
|上汽大众|3|<li>全屏广告-弹窗广告<li>局部广告-悬浮广告<li>局部广告-卡片广告|
|少年梦阅读|1|<li>开屏广告|
|设备信息|1|<li>分段广告-卡片广告|
|设置|1|<li>功能类-选默认USB连接方式|
...
|食卡卡|3|<li>开屏广告<li>其他-开屏误触后的返回操作<li>全屏广告-获取设备|
|视趣|1|<li>全屏广告-弹窗广告|
...
|滔滔对讲|1|<li>开屏广告|
|淘宝|16|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告-横幅广告<li>局部广告-悬浮广告<li>权限提示-通知权限<li>功能类-各级页面添加到首页弹窗<li>更新提示<li>功能类-关闭小额免密支付<li>功能类-将小组件添加到手机桌面<li>权限提示-悬浮窗权限<li>全屏广告-花呗推荐弹窗<li>局部广告-商品详情页直播悬浮窗<li>功能类-登录授权<li>全屏广告-支付后的推荐弹窗<li>功能类-自动隐藏搜索页[猜你想搜][热榜]<li>功能类-付款前邀开通先用后付|
...
|腾讯视频|9|<li>开屏广告<li>更新提示<li>分段广告-卡片广告<li>全屏广告-视频播放时的广告<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>局部广告-卡片广告<li>局部广告-悬浮广告<li>评价提示-视频播放界面的评价悬浮窗|
|腾讯手游加速器|2|<li>局部广告-悬浮广告<li>局部广告-信息流内嵌广告|
|腾讯体育|2|<li>开屏广告<li>全屏广告-首页|
|腾讯微云|1|<li>开屏广告|
...
|铁路12306|2|<li>开屏广告<li>局部广告-下方横幅广告|
...
|网易云游戏|3|<li>全屏广告<li>局部广告-卡片广告<li>功能类-自动签到|
...
|稀饭动漫|1|<li>全屏广告-弹窗广告|
|稀土掘金|1|<li>更新提示|
|喜马拉雅|7|<li>局部广告-播放页广告<li>分段广告-信息流广告<li>青少年模式<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>全屏广告-免流提示<li>全屏广告-签到弹窗|
...
|系统界面|5|<li>功能类-自动允许网易云音乐共享整个屏幕<li>功能类-自动允许白描共享整个屏幕<li>功能类-自动允许QQ音乐共享整个屏幕<li>功能类-自动允许USB调试<li>功能类-自动允许无线调试(真我📱)|
|系统升级(VIVO)|1|<li>通知提示-系统更新提示|
...
|小米视频|3|<li>分段广告-卡片广告<li>局部广告<li>全屏广告-弹窗广告|
|小米相册|3|<li>功能类-删除时勾选[同时从云端删除]<li>功能类-流量同步自动点击[继续同步]<li>其他-图片保存成功弹窗|
|小米移动|1|<li>评价提示|
|小米音乐|9|<li>开屏广告<li>局部广告-悬浮广告<li>局部广告-横幅广告<li>全屏广告-弹窗广告<li>全屏广告-弹窗广告（部分误触）<li>功能类-看广告视频领VIP<li>局部广告-主界面卡片广告<li>分段广告-首页卡片广告<li>全屏广告-体验臻品音质|
|小米应用商店|9|<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>功能类-忽略升级<li>权限提示-通知权限<li>局部广告-个性化推荐卡片<li>功能类-自动点击[查看全部升级]<li>功能类-移动数据更新弹窗点击继续<li>功能类-[安装新版本需要关闭应用商店]弹窗<li>功能类-启动后自动打开更新页面|
|小米游戏服务|1|<li>更新提示|
...
|小蚁摄像机|4|<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>局部广告-卡片广告<li>权限提示-全屏获取权限提示|
|小宇宙|1|<li>全屏广告-内容推荐|
|小猿口算|1|<li>评价提示|
...
|学习通|6|<li>开屏广告<li>功能类-无网络时[重试/确定]<li>功能类-[继续]使用流量播放<li>权限提示-通知权限<li>功能类-电脑端登录自动确认<li>功能类-自动完成普通签到|
...
|一个木函|3|<li>局部广告<li>评价提示<li>功能类-[关闭]保存成功弹窗|
...
|医考帮|3|<li>全屏广告-弹窗广告<li>局部广告<li>局部广告-悬浮窗广告|
|移动爱家|3|<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-卡片广告|
|亿通行|1|<li>全屏广告-出站后摇一摇广告|
|易捷加油|2|<li>全屏广告-弹窗广告<li>权限提示-定位权限|
|易快报|1|<li>局部广告-首页横幅广告|
|易视看|3|<li>局部广告-卡片广告<li>全屏广告-弹窗广告<li>分段广告-首页下方广告|
|易校园|5|<li>功能类-自动点击右上角扫一扫<li>功能类-用水自动点击开始<li>全屏广告<li>更新提示<li>权限提示-通知权限|
...
|应用宝|2|<li>功能类-关闭登录弹窗<li>全屏广告-签到弹窗|
|应用汇|2|<li>开屏广告<li>全屏广告-弹窗广告|
|应用商店|4|<li>开屏广告<li>其他-[您是否年满 18 岁？]弹窗<li>全屏广告-[大家还下载了]弹窗<li>全屏广告-应用推荐广告|
...
|用药助手|8|<li>更新提示<li>功能类-自动领取每日叮当奖励<li>功能类-自动展开详细信息<li>功能类-自动横屏观看表格<li>全屏广告<li>局部广告<li>评价提示<li>功能类-诊疗问答打开图片|
|优酷视频|4|<li>全屏广告-视频推荐弹窗<li>全屏广告-视频播放时的广告<li>局部广告-卡片广告<li>分段广告-首页卡片广告|
|优衣库|2|<li>全屏广告-弹窗广告<li>更新提示|
|悠洗|1|<li>全屏广告-弹窗广告|
|邮储银行|4|<li>更新提示<li>全屏广告-首页弹窗广告<li>局部广告-首页-浮窗广告<li>其他-无视网络代理风险[继续]使用|
|游民星空|3|<li>开屏广告<li>局部广告-卡片广告<li>功能类-签到成功弹窗|
|有道翻译官|1|<li>分段广告-翻译结果下方广告|
...
|悦通行|1|<li>功能类-扫码确认解锁|
|悦享校园|2|<li>局部广告<li>全屏广告|
|阅读|3|<li>全屏广告-首页弹窗广告<li>局部广告-首页浮窗广告<li>局部广告-今日推荐|
|越牛新闻|1|<li>开屏广告|
|云·绝区零|1|<li>功能类-自动点击[使用流量进行游戏]|
|云·星穹铁道|2|<li>功能类-自动点击[下载版本更新]<li>功能类-自动点击[使用流量进行游戏]|
|云·原神|3|<li>功能类-自动点击[下载版本更新]<li>功能类-自动点击[使用流量进行游戏]<li>功能类-中断自动重连|
...
|运动世界|7|<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>分段广告-卡片广告<li>通知提示-公告<li>权限提示-不开启可选权限<li>权限提示-定位权限<li>功能类-运动页面自动切换至校园跑|
|湛庐阅读|1|<li>更新提示|
|章鱼记账|1|<li>全屏广告|
...
|中国工商银行|5|<li>全屏广告-弹窗广告<li>评价提示<li>局部广告-右下角浮标广告<li>功能类-未登录时自动点击登录<li>权限提示-通知权限|
|中国广电|1|<li>更新提示|
|中国建设银行|3|<li>开屏广告<li>全屏广告-弹窗广告<li>通知提示-VPN风险弹窗|
|中国军号|2|<li>开屏广告<li>局部广告-右侧悬浮窗|
|中国联通|5|<li>权限提示<li>更新提示<li>全屏广告-首页弹窗广告<li>局部广告-首页右下角卡片悬浮窗<li>全屏广告-剩余话费弹窗广告|
...
|Android 系统|2|<li>功能类-app无响应-关闭<li>功能类-VIVO-继续使用VPN|
...
|Fa米家|1|<li>更新提示|
|flomo浮墨笔记|2|<li>评价提示<li>功能类-启动后自动点击新建卡片|
|GoFun出行|1|<li>全屏广告-弹窗广告|
|Google Play 服务|1|<li>功能类-谷歌填充密码自动授权|
|Google Play 商店|7|<li>功能类-Play保护机制弹窗<li>全屏广告-弹窗广告<li>功能类-不开启生物识别支付<li>通知提示-隐私政策更新<li>评价提示-应用评分<li>更新提示-某应用有更新<li>更新提示-继续前往Google Play|
...
|MT管理器|2|<li>更新提示<li>通知提示-优惠活动弹窗|
|MT管理器Pro|1|<li>更新提示|
...
|PU口袋校园|6|<li>全屏广告-弹窗广告<li>局部广告-首页-右侧浮窗广告<li>权限提示-通知权限<li>功能类-打开应用自动进入部落<li>功能类-报名成功自动返回<li>功能类-签到成功自动返回|
|QQ浏览器|4|<li>开屏广告<li>分段广告-文件界面-卡片广告<li>分段广告-小说阅读页面-卡片广告<li>分段广告-小说阅读页面-视频广告|
...
|WakeUp课程表|4|<li>评价提示<li>更新提示<li>功能类-[询问是否保存编辑]弹窗点击[离开]<li>全屏广告|
...
|X(推特)|14|<li>分段广告-主页信息流广告<li>分段广告-帖子详情页、搜索页信息流广告<li>分段广告-用户资料页信息流广告<li>评价提示<li>权限提示-通知权限<li>功能类-自动点击翻译<li>功能类-自动[显示更多帖子]<li>其他-关闭[开启个性化广告]弹窗<li>功能类-自动显示可能的垃圾信息<li>功能类-[保存]图片帖子<li>功能类-网络错误自动重试<li>功能类-进入视频自动静音<li>功能类-查看潜在敏感内容的个人页面<li>局部广告-账号详情-小蓝标认证|
|ZK助手|1|<li>全屏广告-弹窗广告|
